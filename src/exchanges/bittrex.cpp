...
bool isOrderComplete(Parameters& params, std::string orderId)
{
  ...
  unique_json root { authRequest(params, "/api/v1.1/market/getopenorders","market=USDT-LTC")};
...
double getLimitPrice(Parameters& params, double volume, bool isBid) {
  ...
  unique_json root { exchange.getRequest("/api/v1.1/public/getorderbook?market=USDT-LTC&type=both") };
